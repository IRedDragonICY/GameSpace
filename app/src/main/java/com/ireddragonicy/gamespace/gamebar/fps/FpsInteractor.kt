...
class FpsInteractor @Inject constructor(private val context: Context) {
    ...
    val fpsHistory: StateFlow<List<Float>> get() = _realFpsHistory
    val interpolatedFpsHistory: StateFlow<List<Float>> get() = _totalFpsHistory
        ...
        coroutineScope.launch {
            fpsFlow
                ...
                .collect { reportedFps ->
                    ...
                    val afmeOn = SystemProperties.getBoolean("persist.sys.afme.enable", false)
