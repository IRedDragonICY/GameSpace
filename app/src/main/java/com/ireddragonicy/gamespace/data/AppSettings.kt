...
class AppSettings @Inject constructor(private val context: Context) {
    ...
    var hubCarouselMode: Boolean
        get() = db.getBoolean("hub_carousel_mode", false)
        set(value) = db.edit().putBoolean("hub_carousel_mode", value).apply()
    ...
    var launchAppInBubble: Boolean
        get() = db.getBoolean(KEY_LAUNCH_APP_IN_BUBBLE, true)
        set(value) = db.edit().putBoolean(KEY_LAUNCH_APP_IN_BUBBLE, value).apply()
