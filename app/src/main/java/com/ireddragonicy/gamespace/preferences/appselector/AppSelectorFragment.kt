 ...
 */
package com.ireddragonicy.gamespace.preferences.appselector
...
class AppSelectorFragment : Hilt_AppSelectorFragment() {
    ...
    @Inject
    lateinit var installedApps: com.ireddragonicy.gamespace.data.repo.InstalledAppsRepository
    ...
    private fun loadApps() {
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            val apps = installedApps.launchableApps().filter {
                it.packageName != ownPkg && it.packageName !in registered
            }
                ...
                val pref = Preference(requireContext()).apply {
                    ...
                    setOnPreferenceClickListener {
                        requireActivity().setResult(
                            Activity.RESULT_OK,
                            Intent().apply { putExtra(AppListPreferences.EXTRA_APP, app.packageName) },
                        )
